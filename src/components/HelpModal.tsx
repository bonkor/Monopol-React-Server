    ...
    <div className="absolute inset-0 bg-white/40 flex items-center justify-center z-50">
      <div className="relative bg-white p-6 rounded-xl shadow-2xl w-[90vw] h-[90vh] animate-fade-in flex flex-col gap-4 overflow-auto">
        ...
        <p className="text-sm text-gray-700">
          ...
          будет ли игрок ботом или управляться человеком. (Боты пока не работают)))
        </p>
        <p className="text-sm text-gray-700">
        ...
        <p className="text-sm text-gray-700">
          ...
          кнопки действий. Такие, как "Купить", "Придать", "Поставить мезон", "Получить". В зависимости от текущей ситуации
          не все кнопки активны. При клике на верхную строку панели фирмы (там где фла, название страны и индустрия)
