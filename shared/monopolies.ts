...
export const monopolies: Monopoly[] = [
  ...
  { id: 'Port', name: 'Порты', companyIndexes: [5, 15, 25, 35], multiplier: 2 },
  { id: 'Spy', name: 'Разведка', companyIndexes: [26, 27, 29], multiplier: 2 },
  ...
  { id: 'Radio', name: 'Радиостанции', companyIndexes: [6, 7, 9], multiplier: 2 },
  { id: 'Food', name: 'Пищевые', companyIndexes: [11, 12, 14], multiplier: 2 },
  { id: 'Media', name: 'Информагентства', companyIndexes: [36, 37, 39], multiplier: 2 },
  { id: 'Automotive', name: 'Автоконцерны', group: 'industry', companyIndexes: [40, 45, 46, 48, 52, 55], multiplier: 2 },
  { id: 'Electro', name: 'Электронная промышленность', companyIndexes: [21, 22, 24], multiplier: 2 },
  { id: 'Oil', name: 'Нефтяная промышленность', companyIndexes: [1, 2, 4], multiplier: 2 },
  { id: 'Studio', name: 'Киностудии', companyIndexes: [31, 32, 34], multiplier: 2 },
  { id: 'Avia', name: 'Авиация', companyIndexes: [16, 17, 19], multiplier: 2 },
